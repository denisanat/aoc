...
let cadenas = input.split("\n")

const numeros = ['1', '2', '3', '4', '5', '6', '7', '8', '9', '0']

//primerNumero = (cadena) => cadena.split("").find(car => car in numeros) == undefined ? 0 : 1;
primerNumero = (cadena) => {
    for (let car of cadena.split("")) {
        if (car in numeros) 
            return car;
    }
    return 0;
...
cadenas.map(cadena => valores.push(`${primerNumero(cadena)}${ultimoNumero(cadena)}`));
